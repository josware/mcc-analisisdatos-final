...
printStats <- function(inBest) {
  out.sep <- "--------------------------------------------------------------------------------"
  out.items.weight <- inBest %*% items$weight
  out.survival.points <- inBest %*% items$survivalpoints
  print(out.sep)
  print("Vector: ")
  print(inBest)
  print(paste("Items weight: ", out.items.weight))
  print(paste("Survival points of this vector: ", out.survival.points))
  print(out.sep)
  } 
```
