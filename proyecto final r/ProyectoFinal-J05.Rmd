...
# create device
?jpeg
jpeg('correlacioneslab.jpg', width=1200, height=800)
...
```{r}
set.seed(2020)
kmea<- kmeans(mi.iris[,c("Petal.Length", "Petal.Width")], 3)
...
```{r}
plot(clustering.kmeans[,c("Petal.Length", "Petal.Width") ], 
     col = kmeans.3$cluster)

points(kmeans.3$centers[,c("Petal.Length", "Petal.Width")],
       col = 1:3,
       pch = 4, cex=2) 
```
